...
export const Overlay = () => {
  ...
  return (
    <>
      <div
        className={`fixed z-10 top-0 left-0 bottom-0 right-0 flex flex-col justify-between pointer-events-none font-manrope text-black ${
          visible ? "" : "opacity-0"
        } transition-opacity duration-1000`}
      >
        <div className="text-2xl font-bold text-center mx-auto pt-4">
          Virtual Garage
          <p className="text-sm text-gray-500">Collection of CGI works</p>
        </div>
        ...
        <div className="bg-gradient-to-t from-white/90 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          ...
          <div className="text-center text-sm text-gray-300 mt-4">
            <p>The template is from WAWA sensei</p>
          </div>
        </div>
      </div>
    </>
